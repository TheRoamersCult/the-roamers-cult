...
const galleriesData = {
  ...
  harishchandragad: {
    ...
    images: [
      ...
      { src: "/harishchandragad/harishc (6).JPG", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (7).JPG", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (8).JPG", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (9).JPG", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (10).JPG", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (11).JPG", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (12).JPG", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (13).JPG", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (14).JPG", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (15).JPG", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (16).JPG", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (17).JPG", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (18).JPG", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (19).JPG", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (20).JPG", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (21).JPG", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (22).jpg", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (23).JPG", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (24).JPG", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (25).JPG", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (26).JPG", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (27).JPG", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (28).JPG", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (29).jpg", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (30).jpg", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (31).jpg", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (32).jpg", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (33).jpg", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (34).JPG", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (35).jpg", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (36).jpg", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (37).jpg", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (38).jpg", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (39).jpg", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (40).jpg", caption: "Summit celebration" },

      { src: "/harishchandragad/harishc (41).jpg", caption: "Konkan Kada breathtaking cliff view" },
      { src: "/harishchandragad/harishc (42).jpg", caption: "Trekking towards the peak" },
      { src: "/harishchandragad/harishc (43).jpg", caption: "Ancient rock-cut caves" },
      { src: "/harishchandragad/harishc (44).jpg", caption: "Sunset from the fort" },
      { src: "/harishchandragad/harishc (45).jpg", caption: "Summit celebration" },
    ],
  },
};
